      ...
      <main>
        ...
        <section id="about" className="story-block" aria-labelledby="story-title">
          <div className="story-text">
            ...
            <p>
              L&apos;étoile was born from a dream to bring the authentic flavors of Lebanon to our community. Since 1985,
      ...
      <footer className="site-footer" id="contact">
        <div className="footer-content">
          ...
          <div className="contact-info">
            <h4>Contact Info</h4>
            <ul>
              <li>123 Bakery Street, Beirut</li>
              <li>+961 1 234 567</li>
              <li>hello@letoile.lb</li>
...
function App() {
  ...
  return (
    <>
      <HomePage onFindLocation={() => setShowContact(true)} onShowMenu={() => setShowMenu(true)} />
    </>
  )
}
